...
let questions = [
{ // question 1
	"question": "In The Matrix, does Neo take the Blue pill to move forward?",
...
{// question 2
	"question": "Elizabeth Taylor married the same man twice.",
...
(function()
{
	...
	document.getElementById("score").addEventListener('click', function(event)
	{
		fnReset();
	});
